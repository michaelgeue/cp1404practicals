...
a 50% chance it increases by 0 to between 10 and 20%, and
a 50% chance that it decreases by 0 to between 5% - 10%.
If the price rises above $100, or falls below $1, the program should end.
The price should be displayed to the nearest cent (e.g. $33.59, not $33.5918232901)
"""
import random

MAX_INCREASE = random.uniform(0.1, 0.2)  # From 10 - 20%
MAX_DECREASE = random.uniform(.05, 0.1)  # 5 - 10%
MIN_PRICE = 1
MAX_PRICE = 100
INITIAL_PRICE = 10.0
